view: jhu_uscovid {
  ...
  measure: total_cumulative_cases_population {
    ...
    type: number
    sql: CASE WHEN (${census_data_view.population} IS NULL OR WHEN ${census_data_view.population} =  0) THEN ${total_cumulative_cases} ELSE ${total_cumulative_cases} / ${census_data_view.population}*1000000 END;;
  }
